import { HistoricalDisaster, PredictionModelPoint } from '@/types';

export const mock50YearDisasters: HistoricalDisaster[] = [
  {
    id: 'HIST-2024-WYD',
    year: 2024,
...
export const mockPrediction7Days: PredictionModelPoint[] = [
...
export const mockPrediction30Days: PredictionModelPoint[] = [
...
export function calculateSimulatedRisk(rainfall: number, seismic: number, soilSaturation: number, slopeDeg: number) {
