export interface PoliceStation {
  ...
  status: 'ACTIVE_24X7' | 'PATROL_DISPATCHED';
}
...
export interface GovernmentEmergencyContact {
  ...
  department: string;
  description: string;
  iconType: 'police' | 'fire' | 'ambulance' | 'disaster' | 'women' | 'child' | 'ndrf';
  tollFree: boolean;
...
export const governmentEmergencyDirectory: GovernmentEmergencyContact[] = [
  {
    number: '112',
