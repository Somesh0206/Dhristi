...
export default function SecureChatPage() {
  ...
  const [activeRole, setActiveRole] = useState<'CITIZEN' | 'STAFF' | 'ADMIN'>('CITIZEN');
                        ...
                        >
                          ...
                          <div
                            className={`mt-2 pt-1.5 border-t ${
                              isSelf ? 'border-emerald-500/40 text-emerald-200' : 'border-slate-200 dark:border-slate-700 text-slate-400'
