import { Habitation, HazardZone, Shelter, SosAlert, IncidentReport } from '@/types';
...
class BackendStore {
  private static instance: BackendStore;

  public zones: HazardZone[] = [...mockHazardZones];
  public habitations: Habitation[] = [...mockHabitations];
  public shelters: Shelter[] = [...mockShelters];
  public sosAlerts: SosAlert[] = [
    {
      id: 'SOS-2026-001',
  ...
  public static getInstance(): BackendStore {
