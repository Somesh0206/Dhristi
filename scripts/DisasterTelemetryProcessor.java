 ...
 * Java utility for processing telemetry feeds and computing geotechnical safety factors.
...
public class DisasterTelemetryProcessor {
    ...
    public static class HazardZone {
        ...
        public String getRiskStatus() {
            if (this.factorOfSafety < 1.0 || this.rainfallRate > 50.0) return "CRITICAL_RED";
            if (this.factorOfSafety < 1.3 || this.rainfallRate > 30.0) return "WARNING_AMBER";
            return "STABLE_GREEN";
        }
    ...
    public static void main(String[] args) {
        ...
        System.out.println("\n-------------------------------------------------");
        System.out.println("Summary: " + redCount + " of " + zones.length + " monitored zones require IMMEDIATE evacuation dispatch.");
        System.out.println("-------------------------------------------------");
    }
}
